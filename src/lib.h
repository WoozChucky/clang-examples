...
inline Vec2 operator/(Vec2 a, int scalar)
{
...
inline IVec2 operator/(IVec2 a, float scalar)
{
...
inline IVec2 operator-(IVec2 a, int scalar)
{
...
inline Vec2 vec_2(IVec2 ivec2)
{
  return Vec2{(float)ivec2.x, (float)ivec2.y};
}

inline Vec2 vec_2(float scalar)
{
  return Vec2{scalar, scalar};
}

inline IVec2 ivec_2(Vec2 v)
{
